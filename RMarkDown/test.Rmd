...
if(require("webshot2", quietly = TRUE)) {
  if(!webshot2::webshot_available()) {
    cat("Installing Chrome/Chromium for webshot2...\n")
    # webshot2 uses Chrome/Chromium which should be available
  }
}
```
...
> *"Running economy is considered one of the three primary physiological determinants of distance running performance, alongside VO₂max and lactate threshold"* [@bassett2000limiting].
