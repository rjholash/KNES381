...
```{r interactive-scatter, fig.cap="Interactive scatter plot showing the relationship between running economy and 10K race performance", fig.width=8, fig.height=6}
